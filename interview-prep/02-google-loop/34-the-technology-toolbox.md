...
*In the Google round: every technology you name will be followed by "why not the other one?". Know the trade-off, and know the Google-published system it descends from ([36](36-google-scale-vocabulary.md)).*
