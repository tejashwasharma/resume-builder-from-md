...
| Migrations | `node-pg-migrate` or `Prisma Migrate` | Versioned, reversible schema changes — see the expand/contract steps in [cicd-and-observability](../06-cloud-devops/02-cicd-and-observability.md) |
